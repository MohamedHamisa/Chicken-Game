import pygame          #to help you to make game and multimedia apps
import random
...
keep_alive = True
clock = pygame.time.Clock()   #time of falling chicken

while keep_alive:          #game loop
    pygame.event.get()
    ...
    screen.blit(background, [0, 0])   #screen.blit allows you to draw images to thescreen
